...
export const dictionaries = {
  fa: {
    ...
    sections: {
      ...
      trendingTitle: 'در حال ترند',
      trendingDesc: 'پربازدیدترین طراحی‌های هفته.',
      newArrivalsTitle: 'تازه‌ها',
      newArrivalsDesc: 'آخرین طراحی‌هایی که به مورو اضافه شده‌اند.',
      collectionsTitle: 'مجموعه‌ها',
      collectionsDesc: 'انتخاب‌های سردبیر با تم‌های داستانی.',
      browseCollections: 'مرور همه مجموعه‌ها',
      discoverMoreTitle: 'بیشتر کاوش کن',
      discoverMoreDesc: 'به بازار کامل مورو بروید و هزاران طراحی دیگر را کشف کنید.',
      itemsUnit: 'مورد',
      trendingTitle: 'در حال ترند',
      trendingDesc: 'پربازدیدترین طراحی‌های هفته.',
    // Extensions (homepage previews only)
    extensions: {
      eyebrow: 'از استودیوی مورو',
      portfolioTitle: 'نمونه‌کار',
      portfolioDesc: 'کارهای خلاقانه‌ی حرفه‌ای صاحب مورو — پروژه‌های منتخب، کمپین‌ها و همکاری‌ها.',
      portfolioCta: 'مشاهده نمونه‌کار',
      educationTitle: 'آموزش',
      educationDesc: 'دوره‌ها، وبینارها، کارگاه‌ها و کلاس‌های استاد برای پیشرفت مهارت‌های طراحی شما.',
      educationCta: 'کاوش دوره‌ها',
      ownerShopTitle: 'فروشگاه مورو',
      ownerShopDesc: 'محصولات انحصاری و محدود صاحب مورو — با ارائه‌ی ممتاز.',
      ownerShopCta: 'ورود به فروشگاه',
      comingSoon: 'به‌زودی',
    },
      ...
      browseCollections: 'مرور همه مجموعه‌ها',
      discoverMoreTitle: 'بیشتر کاوش کن',
      discoverMoreDesc: 'به بازار بازار مورو بروید و هزاران طراحی دیگر را کشف کنید.',
      itemsUnit: 'مورد',
      moreDesigns: 'طراحی‌های بیشتر',
    },
  ...
  en: {
    ...
    hero: {
      ...
      trendingDesc: 'The most-viewed designs this week.',
      newArrivalsTitle: 'New arrivals',
      newArrivalsDesc: 'The latest designs added to Morrow.',
      collectionsTitle: 'Collections',
      collectionsDesc: 'Editor-curated selections with a story to tell.',
      browseCollections: 'Browse all collections',
      discoverMoreTitle: 'Discover more',
      discoverMoreDesc: 'Head to the full marketplace and explore thousands more designs.',
      itemsUnit: 'items',
      titleLine1: 'A world of pattern,',
      titleLine2: 'made by people.',
    extensions: {
      eyebrow: 'From the Morrow studio',
      portfolioTitle: 'Portfolio',
      portfolioDesc: 'The owner\'s professional creative work — selected projects, campaigns and collaborations.',
      portfolioCta: 'View portfolio',
      educationTitle: 'Education',
      educationDesc: 'Courses, webinars, workshops and masterclasses to grow your design skills.',
      educationCta: 'Explore courses',
      ownerShopTitle: 'Morrow Shop',
      ownerShopDesc: 'Exclusive, limited owner products — presented with care.',
      ownerShopCta: 'Enter the shop',
